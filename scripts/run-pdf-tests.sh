#!/bin/bash
# =========================================================================
# Bash PDF E2E 통합 테스트 러너 (scripts/run-pdf-tests.sh)
# 헌법 제VI조(대칭 툴링) 및 제VIII조(TestCase 하이브리드) 영구 수호
# =========================================================================

set -e

CONTAINER_NAME="ai-ledger-db-test"
VOLUME_NAME="postgres_data_test"
DB_PORT="54321"
DB_NAME="ledgerdb_test"
DB_USER="dbuser_test"
DB_PASSWORD="dbpassword_test_secure"

echo -e "\033[36m========================================================\033[0m"
echo -e "\033[36m🚀 PDF 로컬 통합 E2E 무결성 검증 프로세스를 개시합니다...\033[0m"
echo -e "\033[36m========================================================\033[0m"
...
echo -e "\033[36m⚙️ [Step 4/4] Pytest 통합 검증 스위트 기동...\033[0m"
uv run pytest backend/tests/integration/test_pdf_integration.py -v

echo -e "\n\033[32m🎉 [무결성 통과] 모든 1주차 인프라 통합 검증이 100% 성공 완료되었습니다!\033[0m"
echo -e "\033[32m성공 기준(SC-001, SC-002, SC-003)이 기계적으로 안전히 입증되었습니다.\033[0m\n"
